...
#     NAME => q[Vigil::Crypt]
#     PREREQ_PM => { Bytes::Random::Secure=>q[0], Crypt::Argon2=>q[0], Crypt::AuthEnc::ChaCha20Poly1305=>q[0], Digest::SHA=>q[0], Time::Local=>q[0] }
#     TEST_REQUIRES => {  }
...
ppd :
	$(NOECHO) $(ECHO) "<SOFTPKG NAME=\"Vigil-Crypt\" VERSION=\"2.1.0\">" > Vigil-Crypt.ppd
